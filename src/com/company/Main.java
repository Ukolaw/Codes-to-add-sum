...
public class Main {
    ...
    public static String checkID(String acctNum, String pwd)
    {
        ...
        String a = "11111 tataro 90.00";
        String b = "222222-6 anotherpassword 160.00";
        String c = "33333-0 betterpassword 300,000.70";
        ...
        while (menuOption != 4)
        {
            ...
            switch (menuOption)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.print("\nThanks For Using My ATM.  Have a Nice Day.  Good-Bye!");
                    System.exit(0);
                    break;
            }
        }
